...
# check if the img is dog or cat
def dogs_cats_classifier(filename):
...
dogs_cats_classifier(r"C:\Users\USER\dog_cat_images\dogs\unknown1.jpeg")
...
print(len(unique_breeds), unique_breeds[:10])
...
def dogs_breeds_classifier(filename):
...
dogs_breeds_classifier(r"C:\Users\USER\dog_cat_images\dogs\unknown1.jpeg")
...
def cats_breeds_classifier(filename):
    img = load_img(filename, target_size=(224, 224))
    # show image
    plt.figure(figsize=(4, 4))
    plt.imshow(img)
...
cats_breeds_classifier(r"C:\Users\USER\dog_cat_images\cats\cat10.jpeg")
