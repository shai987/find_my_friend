...
const ContactForm = () => {
    const [formStatus, setFormStatus] = React.useState('שלח טופס')
    const onSubmit = (e) => {
      e.preventDefault()
      setFormStatus('שולח...')
