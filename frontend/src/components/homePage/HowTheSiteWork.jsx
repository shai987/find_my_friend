...
const steps = ['האתר שלנו מכיל מאגר של כלבים וחתולים שהלכו לאיבוד', 'הכניסו תמונה של בעל החיים', 'תנו למערכת שלנו לעשות עבורכם את החיפוש'];
